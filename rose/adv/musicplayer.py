...
Kutty Angel has a additional feature for non-admin users who want to use admin commands.
...
- /sudolist : Check Sudo Users of Kutty Angel Music Bot
- /song or /video  `[Track Name]` or `[YT Link]` : Download any track from youtube in mp3 or mp4 formats via Kutty Angel.
...
supunmas = """
**Note:**
Kutty Angel Music Bot works on a single merged 
commands for Music and Video

**Youtube,Telegram Files & query**:

- /play `[Music Name](Kutty Angel will search on Youtube)
...
- /playplaylist : Start playing Your Saved Playlist on Kutty Angel Servers.
...
supunmasc = """
We was added **Single Assistant Mode** for  Chats.

👮‍♀️ **OFFICIAL Assistants**:-

• Assistant :- @kuttyangelrose
...
- Single Assistant Mode for Chats.
- Interactive UI, Fonts and Thumbnails.

**Original work is done by** : @ONLY_DUSKY

Click on the buttons for more information.| [credits](https://t.me/KuttyAngelUpdates)
"""
