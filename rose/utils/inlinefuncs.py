...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/e15af272988e5db2c0f33.jpg",
...
async def alive_function(answers):
    ...
    msg = f"""
**[Kutty Angel](https://github.com/duskyjoe/Private):**
**System Stats:**
**MainBot:** `{bot_state}`
...
[->> Shorter the Way, Faster you Go! 🏃‍♂️](https://t.me/KuttyAngelXUpadtes) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
